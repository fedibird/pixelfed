	...
	<div class="embed-card border">
		<div class="card status-card-embed card-md-rounded-0 card-body shadow-none rounded-0">
			<div class="text-center p-5">
				...
				<p class="h2 py-3 font-weight-bold">{{ config('app.name', 'Pixelfed') }}</p>
				...
				<p><a href="{{config('app.url')}}" class="font-weight-bold" target="_blank">Visit {{ config('app.name', 'Pixelfed') }}</a></p>
			</div>
		</div>
	</div>
